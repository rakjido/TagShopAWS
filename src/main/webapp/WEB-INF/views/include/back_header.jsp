    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="index.html"><img src="${pageContext.request.contextPath}/resources/img/core-img/태그샵14.png" alt=""></a>
                <!-- Navbar Toggler -->
                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul>
                            ...
                            <li><a href="blog.html">Blog</a></li>
                            <li><a href="contact.html">Contact</a></li>
                            <li><a href="sellerhome.html">Seller</a></li>
                            <li><a href="sales-apply.html">Sales Apply</a></li>
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="user-login-info-open">
                    <input type="checkbox" id="user-login-info-open" class="user-login-info-open" data-role="none">
                        <label for="user-login-info-open" class="user-login-info-open">
                            <img src="${pageContext.request.contextPath}/resources/img/core-img/lock-outline.svg">
                        </label>
                    </input>
                    <!-- ##### Mypage Button Start ##### -->
