...
<div class="row mt-5">
                <div class="col-md-12 text-center footer_info">
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
   			<div><span>상호명 : (주)태그샵 이메일 : contact@tagshop.com 사업자등록번호 : 132-78-91321 통신판매업신고번호 : 제2019-서울강남-0270호 주소 : 서울특별시 강남구 테헤란로7길 32 태그샵</span></div>
                    <div>NICEPAY 안전거래 서비스 : 고객님의 안전거래를 위해 현금 결제 시, 저희 사이트에서 가입한 구매안전 서비스를 이용할 수 있습니다.</div>
    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
    </footer>
