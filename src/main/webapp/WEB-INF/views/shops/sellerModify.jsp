                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="sales_infor">
                                    ...
                                    <input type="text" class="form-control" id="sales_apply_myhomeurl" value="${shopinfo.shopid }" required
                            ...
                            <div class="col-7">
                                <div class="sales_infor">
                                    ...
                                    <input type="tel" class="form-control" id="sales_apply_phone" name="phone" value="${shopinfo.phone }" maxlength="11" placeholder="'-'없이 입력 해주세요">
                                </div>
                            ...
                            <div class="col-7">
                                <div class="sales_infor">
                                    ...
                                    <input type="text" class="form-control" id="sales_apply_bankaccount" value="${shopinfo.bankAccount }" required
                ...
                <div class="sales_apply_details mt-50 clearfix">
                    ...
                    <div class="cart-page-heading mb-30">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="sales_infor">
                                    ...
                                    <input type="text" class="form-control" id="sales_apply_brand" value="${shopinfo.brandName }" required
                        ...
                        <div class="col-12 mt-5" style="text-align:center">
                            <button type="submit" name="phonecheck" value="5" class="btn phonecheck-btn">수정</button>
                        </div>
