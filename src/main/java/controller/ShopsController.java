...
public class ShopsController {
	...
	public String productsReg(@PathVariable("shopid") String shopid, MultipartHttpServletRequest request,
			ProductsVo productsVo, ProductItemVo productItemVo, OptionListVo optionsVo)
	...
	// @Transactional
	// @RequestMapping(value="/{userid}/baskets/{productItemid}",
	// method=RequestMethod.POST)
	// public String addBuyitems(@PathVariable("userid") String userid,
	// @PathVariable("productItemid") BigInteger productItemid
	// ) {
	...
	public String shopManagement(Model model) {
		...
		// String fromDate =
		// FormatUtil.dateFormat(DateUtil.changeYear(DateUtil.today(),-1));
